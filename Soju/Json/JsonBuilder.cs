...
public class JsonBuilder {
    ...
    private string InputToJson(DumbCoin input, Wallet wallet, int index, int indentCount)
    {
    ...
    private string OutputToJson(DumbCoin output, Wallet wallet, int indentCount)
    {
