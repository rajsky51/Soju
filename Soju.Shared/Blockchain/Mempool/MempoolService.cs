...
namespace Soju.Blockchain.Mempool;

public class MempoolService
{
	public MempoolService()
	{
		// NOTE: MempoolService is just here to satisfy some other code.
		// Never actually create it.
		Debug.Assert(false, "MempoolService should never be instantiated");
	}
