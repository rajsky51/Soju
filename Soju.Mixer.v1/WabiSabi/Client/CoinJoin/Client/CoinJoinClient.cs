...
using Soju.WabiSabi.Client.CoinJoinProgressEvents;
...
public class CoinJoinClient
{
	...
	public CoinJoinResult StartCoinJoin(RoundState currentRoundState, Func<IEnumerable<SmartCoin>> coinCandidatesFunc, bool stopWhenAllMixed)
	{
