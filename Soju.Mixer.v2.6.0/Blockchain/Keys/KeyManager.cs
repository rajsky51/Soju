...
using Soju.CoinJoinProfiles;
using Soju.Helpers;
using Soju.Io;
using Soju.Logging;
using Soju.Models;
using Soju.Serialization;
using Soju.Wallets;
using Soju.Wallets.Slip39;
using static Soju.Blockchain.Keys.WpkhOutputDescriptorHelper;
...
public class KeyManager
{
	...
	private static JsonNode EncodeKeyManager(KeyManager keyManager) 
		=> throw new NotSupportedException("Don't use EncodeKeyManager");

	private static readonly Decoder<KeyManager> Decoder =
		_ => throw new NotSupportedException("Don't use KeyManager's Decoder");
}
